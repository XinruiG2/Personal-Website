...
const AboutMe = () => {
  ...
  return (
    <Container>
        <Text>
            <b><i>Hello!</i></b> I am a Northeastern CS grad
            who is passionate about web design, seamless
            user experiences, and innovative solutions. I am curently
            enrolled in OMSCS, but actively looking for roles!
        </Text>
